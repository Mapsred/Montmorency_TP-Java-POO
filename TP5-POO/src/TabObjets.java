...
public class TabObjets implements CollectionObjets, Serializable {
	 ...
	 * 
	 * @return true si le tableau d'objets est vide et false dans le cas
	 *         contraire.
	 */
	 ...
	 * 
	 * @return true si le tableau d'objets est plein et false dans le cas
	 *         contraire.
	 */
	
	@Override
	public boolean estPlein() {
		return ( this.taille() == this.tabObjets.length );
	}
	 ...
	 * 
	 * @return l'objet si l'indice fait partie des limites du tableau et null
	...
	public int chercher( Object obj ) {
		...
		while ( indMin <= indMax && !finRecherche ) {
			...
			} else if ( ( (Comparable <Object>) obj )
								.compareTo(	this.tabObjets[indMilieu] ) < 0 ) {
	 ...
	 *            L'objet à ajouter.
	 *            
	 * @return true si l'objet a été ajouté dans le tableau et false dans le cas
	 *         contraire.
	 */
	...
	public boolean ajouter( Object obj ) {
		...
		if ( !this.estPlein() ) {
			...
			while ( indice >= 0 && 
					( (Comparable <Object>) this.tabObjets[indice] )
													.compareTo( obj ) > 0  ) {
	 ...
	 * 
	 * @return Les informations de chaque objet du tableau sous forme de chaîne
	 *         de caractères.
	 */
	@Override
	...
	public static TabObjets lireFicBin( ObjectInputStream ficLecture ) {
		...
		try {
			...
			System.out.println( "\nErreur, impossible de lire un objet "
					+ "de type TabObjets du fichier binaire." );
			tabObjets = null;
		}
	...
	public void ecrireFicBin( ObjectOutputStream ficEcriture ) {
		...
		try {
			...
			System.out.println( "\nErreur d'écriture d'un objet TabObjets "
