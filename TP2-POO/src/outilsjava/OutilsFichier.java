...
public class OutilsFichier {
	 ...
	 * texte en mode lecture bufférisée.
	 * 
	 * @param nomFichier
	 ...
	 * texte en mode écriture bufférisée.
	 * 
	 * @param nomFichier
	 *            Le nom physique du fichier.
	 * @return Le nom logique du fichier si l'ouverture est un succès et null
	 ...
	 * texte en mode lecture bufferisé.
	 * 
	 * @param nomLogique
	 ...
	 * texte en mode écriture bufferisé.
	 * 
	 * @param nomLogique
	 *            Le nom logique du fichier.
	 * @param nomFic
